package com.example.mvcpwads.components.messages.notifications;


import com.example.mvcpwads.components.messages.model.Message;
import com.example.mvcpwads.firebase.CustomFirebaseMessagingService;
...
public class SendPushNotification {
    ...
    @Pointcut("execution(* com.example.mvcpwads.components.messages.controller.MessageController.save(..))")
