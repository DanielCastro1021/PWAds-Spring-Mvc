package com.example.mvcpwads.security.authorization.aspect;

import com.example.mvcpwads.security.models.ERole;
import com.example.mvcpwads.security.exception.UnauthorizedAccessException;
...
public class AccessValidation {
    ...
    @Pointcut("@annotation(com.example.mvcpwads.security.authorization.annotation.AdminAccess)")
    public void methodsWithAdminAccessAnnotation() {
    }

    @Pointcut("@annotation(com.example.mvcpwads.security.authorization.annotation.ModeratorAccess)")
    public void methodsWithModeratorAccessAnnotation() {
    }

    @Pointcut("@annotation(com.example.mvcpwads.security.authorization.annotation.UserAccess)")
