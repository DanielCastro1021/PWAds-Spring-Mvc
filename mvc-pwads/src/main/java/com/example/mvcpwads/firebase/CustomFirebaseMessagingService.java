package com.example.mvcpwads.firebase;
...
public class CustomFirebaseMessagingService {
    ...
    public String sendMessageNotification(EntityModel<com.example.mvcpwads.components.messages.model.Message> model, String token) throws FirebaseMessagingException, IOException {
        com.example.mvcpwads.components.messages.model.Message msg = model.getContent();
